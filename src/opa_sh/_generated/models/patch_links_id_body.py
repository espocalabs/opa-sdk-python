...
T = TypeVar("T", bound="PatchLinksIdBody")


@_attrs_define
class PatchLinksIdBody:
    """
    Attributes:
        destination_url (str):
        domain (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if clear_password is not UNSET:
            field_dict["clearPassword"] = clear_password
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_links_id_body.additional_properties = d
        return patch_links_id_body
