...
if TYPE_CHECKING:
    from ..models.post_track_event_body_type_0_properties import PostTrackEventBodyType0Properties


T = TypeVar("T", bound="PostTrackEventBodyType0")


@_attrs_define
class PostTrackEventBodyType0:
    """
    Attributes:
        event_id (str):
        event_name (str):
        ...
        click_id (str | Unset):
        properties (PostTrackEventBodyType0Properties | Unset):
    ...
    properties: PostTrackEventBodyType0Properties | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.post_track_event_body_type_0_properties import (
        ...
        if isinstance(_properties, Unset):
            ...
            properties = PostTrackEventBodyType0Properties.from_dict(_properties)
        ...
        post_track_event_body_type_0 = cls(
            event_id=event_id,
        ...
        post_track_event_body_type_0.additional_properties = d
        return post_track_event_body_type_0
