...
from ..models.post_links_response_201_data_qr_settings_type_0_dot_style import (
    PostLinksResponse201DataQrSettingsType0DotStyle,
)
from ..models.post_links_response_201_data_qr_settings_type_0_error_correction_level import (
    PostLinksResponse201DataQrSettingsType0ErrorCorrectionLevel,
)
from ..models.post_links_response_201_data_qr_settings_type_0_logo_mode import (
    PostLinksResponse201DataQrSettingsType0LogoMode,
)
from ..models.post_links_response_201_data_qr_settings_type_0_marker_border_style import (
    PostLinksResponse201DataQrSettingsType0MarkerBorderStyle,
)
from ..models.post_links_response_201_data_qr_settings_type_0_marker_center_style import (
    PostLinksResponse201DataQrSettingsType0MarkerCenterStyle,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostLinksResponse201DataQrSettingsType0")


@_attrs_define
class PostLinksResponse201DataQrSettingsType0:
    """
    Attributes:
        foreground_color (str | Unset):
        background_color (str | Unset):
        error_correction_level (PostLinksResponse201DataQrSettingsType0ErrorCorrectionLevel | Unset):
        logo_mode (PostLinksResponse201DataQrSettingsType0LogoMode | Unset):
        custom_logo_url (str | Unset):
        logo_size (int | Unset):
        dot_style (PostLinksResponse201DataQrSettingsType0DotStyle | Unset):
        marker_border_style (PostLinksResponse201DataQrSettingsType0MarkerBorderStyle | Unset):
        marker_center_style (PostLinksResponse201DataQrSettingsType0MarkerCenterStyle | Unset):
    """
    ...
    logo_mode: PostLinksResponse201DataQrSettingsType0LogoMode | Unset = UNSET
    custom_logo_url: str | Unset = UNSET
    logo_size: int | Unset = UNSET
    dot_style: PostLinksResponse201DataQrSettingsType0DotStyle | Unset = UNSET
    marker_border_style: PostLinksResponse201DataQrSettingsType0MarkerBorderStyle | Unset = UNSET
    marker_center_style: PostLinksResponse201DataQrSettingsType0MarkerCenterStyle | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_error_correction_level, Unset):
            ...
            error_correction_level = PostLinksResponse201DataQrSettingsType0ErrorCorrectionLevel(
        ...
        if isinstance(_logo_mode, Unset):
            ...
            logo_mode = PostLinksResponse201DataQrSettingsType0LogoMode(_logo_mode)
        ...
        if isinstance(_dot_style, Unset):
            ...
            dot_style = PostLinksResponse201DataQrSettingsType0DotStyle(_dot_style)
        ...
        if isinstance(_marker_border_style, Unset):
            ...
            marker_border_style = PostLinksResponse201DataQrSettingsType0MarkerBorderStyle(
        ...
        if isinstance(_marker_center_style, Unset):
            ...
            marker_center_style = PostLinksResponse201DataQrSettingsType0MarkerCenterStyle(
                _marker_center_style
            )

        post_links_response_201_data_qr_settings_type_0 = cls(
        ...
        return post_links_response_201_data_qr_settings_type_0
