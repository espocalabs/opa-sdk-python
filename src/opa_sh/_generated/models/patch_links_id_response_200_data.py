...
if TYPE_CHECKING:
    from ..models.patch_links_id_response_200_data_qr_settings_type_0 import (
        PatchLinksIdResponse200DataQrSettingsType0,
    )
    from ..models.patch_links_id_response_200_data_targeting_type_0 import (
        PatchLinksIdResponse200DataTargetingType0,
    )


T = TypeVar("T", bound="PatchLinksIdResponse200Data")


@_attrs_define
class PatchLinksIdResponse200Data:
    """
    Attributes:
        id (str):
        domain (str):
        ...
        targeting (None | PatchLinksIdResponse200DataTargetingType0):
        qr_settings (None | PatchLinksIdResponse200DataQrSettingsType0):
    """
    ...
    targeting: PatchLinksIdResponse200DataTargetingType0 | None
    qr_settings: PatchLinksIdResponse200DataQrSettingsType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.targeting, PatchLinksIdResponse200DataTargetingType0):
            targeting = self.targeting.to_dict()
        else:
            targeting = self.targeting

        qr_settings: dict[str, Any] | None
        if isinstance(self.qr_settings, PatchLinksIdResponse200DataQrSettingsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_targeting(data: object) -> PatchLinksIdResponse200DataTargetingType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                targeting_type_0 = PatchLinksIdResponse200DataTargetingType0.from_dict(data)

                return targeting_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PatchLinksIdResponse200DataTargetingType0, data)

        targeting = _parse_targeting(d.pop("targeting"))

        def _parse_qr_settings(data: object) -> PatchLinksIdResponse200DataQrSettingsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                qr_settings_type_0 = PatchLinksIdResponse200DataQrSettingsType0.from_dict(data)

                return qr_settings_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PatchLinksIdResponse200DataQrSettingsType0, data)

        qr_settings = _parse_qr_settings(d.pop("qrSettings"))

        patch_links_id_response_200_data = cls(
            id=id,
            domain=domain,
            key=key,
        ...
        return patch_links_id_response_200_data
