...
if TYPE_CHECKING:
    from ..models.post_links_response_201_data_qr_settings_type_0 import (
        PostLinksResponse201DataQrSettingsType0,
    )
    from ..models.post_links_response_201_data_targeting_type_0 import (
        PostLinksResponse201DataTargetingType0,
    )


T = TypeVar("T", bound="PostLinksResponse201Data")


@_attrs_define
class PostLinksResponse201Data:
    """
    Attributes:
        id (str):
        domain (str):
        ...
        targeting (None | PostLinksResponse201DataTargetingType0):
        qr_settings (None | PostLinksResponse201DataQrSettingsType0):
    """
    ...
    targeting: PostLinksResponse201DataTargetingType0 | None
    qr_settings: PostLinksResponse201DataQrSettingsType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.targeting, PostLinksResponse201DataTargetingType0):
            targeting = self.targeting.to_dict()
        else:
            targeting = self.targeting

        qr_settings: dict[str, Any] | None
        if isinstance(self.qr_settings, PostLinksResponse201DataQrSettingsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_targeting(data: object) -> PostLinksResponse201DataTargetingType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                targeting_type_0 = PostLinksResponse201DataTargetingType0.from_dict(data)

                return targeting_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostLinksResponse201DataTargetingType0, data)

        targeting = _parse_targeting(d.pop("targeting"))

        def _parse_qr_settings(data: object) -> PostLinksResponse201DataQrSettingsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                qr_settings_type_0 = PostLinksResponse201DataQrSettingsType0.from_dict(data)

                return qr_settings_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PostLinksResponse201DataQrSettingsType0, data)

        qr_settings = _parse_qr_settings(d.pop("qrSettings"))

        post_links_response_201_data = cls(
            id=id,
            domain=domain,
            key=key,
        ...
        return post_links_response_201_data
