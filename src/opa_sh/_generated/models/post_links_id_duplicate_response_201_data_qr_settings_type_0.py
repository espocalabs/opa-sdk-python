...
from ..models.post_links_id_duplicate_response_201_data_qr_settings_type_0_dot_style import (
    PostLinksIdDuplicateResponse201DataQrSettingsType0DotStyle,
)
from ..models.post_links_id_duplicate_response_201_data_qr_settings_type_0_error_correction_level import (
    PostLinksIdDuplicateResponse201DataQrSettingsType0ErrorCorrectionLevel,
)
from ..models.post_links_id_duplicate_response_201_data_qr_settings_type_0_logo_mode import (
    PostLinksIdDuplicateResponse201DataQrSettingsType0LogoMode,
)
from ..models.post_links_id_duplicate_response_201_data_qr_settings_type_0_marker_border_style import (
    PostLinksIdDuplicateResponse201DataQrSettingsType0MarkerBorderStyle,
)
from ..models.post_links_id_duplicate_response_201_data_qr_settings_type_0_marker_center_style import (
    PostLinksIdDuplicateResponse201DataQrSettingsType0MarkerCenterStyle,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostLinksIdDuplicateResponse201DataQrSettingsType0")


@_attrs_define
class PostLinksIdDuplicateResponse201DataQrSettingsType0:
    """
    Attributes:
        foreground_color (str | Unset):
        background_color (str | Unset):
        error_correction_level (PostLinksIdDuplicateResponse201DataQrSettingsType0ErrorCorrectionLevel | Unset):
        logo_mode (PostLinksIdDuplicateResponse201DataQrSettingsType0LogoMode | Unset):
        custom_logo_url (str | Unset):
        logo_size (int | Unset):
        dot_style (PostLinksIdDuplicateResponse201DataQrSettingsType0DotStyle | Unset):
        marker_border_style (PostLinksIdDuplicateResponse201DataQrSettingsType0MarkerBorderStyle | Unset):
        marker_center_style (PostLinksIdDuplicateResponse201DataQrSettingsType0MarkerCenterStyle | Unset):
    """

    foreground_color: str | Unset = UNSET
    background_color: str | Unset = UNSET
    error_correction_level: (
        PostLinksIdDuplicateResponse201DataQrSettingsType0ErrorCorrectionLevel | Unset
    ) = UNSET
    logo_mode: PostLinksIdDuplicateResponse201DataQrSettingsType0LogoMode | Unset = UNSET
    custom_logo_url: str | Unset = UNSET
    logo_size: int | Unset = UNSET
    dot_style: PostLinksIdDuplicateResponse201DataQrSettingsType0DotStyle | Unset = UNSET
    marker_border_style: (
        PostLinksIdDuplicateResponse201DataQrSettingsType0MarkerBorderStyle | Unset
    ) = UNSET
    marker_center_style: (
        PostLinksIdDuplicateResponse201DataQrSettingsType0MarkerCenterStyle | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_logo_mode, Unset):
            ...
            logo_mode = PostLinksIdDuplicateResponse201DataQrSettingsType0LogoMode(_logo_mode)
        ...
        if isinstance(_dot_style, Unset):
            ...
            dot_style = PostLinksIdDuplicateResponse201DataQrSettingsType0DotStyle(_dot_style)
        ...
        post_links_id_duplicate_response_201_data_qr_settings_type_0 = cls(
        ...
        return post_links_id_duplicate_response_201_data_qr_settings_type_0
