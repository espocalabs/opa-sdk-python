...
from ..models.get_links_response_200_data_items_item_qr_settings_type_0_dot_style import (
    GetLinksResponse200DataItemsItemQrSettingsType0DotStyle,
)
from ..models.get_links_response_200_data_items_item_qr_settings_type_0_error_correction_level import (
    GetLinksResponse200DataItemsItemQrSettingsType0ErrorCorrectionLevel,
)
from ..models.get_links_response_200_data_items_item_qr_settings_type_0_logo_mode import (
    GetLinksResponse200DataItemsItemQrSettingsType0LogoMode,
)
from ..models.get_links_response_200_data_items_item_qr_settings_type_0_marker_border_style import (
    GetLinksResponse200DataItemsItemQrSettingsType0MarkerBorderStyle,
)
from ..models.get_links_response_200_data_items_item_qr_settings_type_0_marker_center_style import (
    GetLinksResponse200DataItemsItemQrSettingsType0MarkerCenterStyle,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetLinksResponse200DataItemsItemQrSettingsType0")


@_attrs_define
class GetLinksResponse200DataItemsItemQrSettingsType0:
    """
    Attributes:
        foreground_color (str | Unset):
        background_color (str | Unset):
        error_correction_level (GetLinksResponse200DataItemsItemQrSettingsType0ErrorCorrectionLevel | Unset):
        logo_mode (GetLinksResponse200DataItemsItemQrSettingsType0LogoMode | Unset):
        custom_logo_url (str | Unset):
        logo_size (int | Unset):
        dot_style (GetLinksResponse200DataItemsItemQrSettingsType0DotStyle | Unset):
        marker_border_style (GetLinksResponse200DataItemsItemQrSettingsType0MarkerBorderStyle | Unset):
        marker_center_style (GetLinksResponse200DataItemsItemQrSettingsType0MarkerCenterStyle | Unset):
    """

    foreground_color: str | Unset = UNSET
    background_color: str | Unset = UNSET
    error_correction_level: (
        GetLinksResponse200DataItemsItemQrSettingsType0ErrorCorrectionLevel | Unset
    ) = UNSET
    logo_mode: GetLinksResponse200DataItemsItemQrSettingsType0LogoMode | Unset = UNSET
    custom_logo_url: str | Unset = UNSET
    logo_size: int | Unset = UNSET
    dot_style: GetLinksResponse200DataItemsItemQrSettingsType0DotStyle | Unset = UNSET
    marker_border_style: (
        GetLinksResponse200DataItemsItemQrSettingsType0MarkerBorderStyle | Unset
    ) = UNSET
    marker_center_style: (
        GetLinksResponse200DataItemsItemQrSettingsType0MarkerCenterStyle | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_logo_mode, Unset):
            ...
            logo_mode = GetLinksResponse200DataItemsItemQrSettingsType0LogoMode(_logo_mode)
        ...
        if isinstance(_dot_style, Unset):
            ...
            dot_style = GetLinksResponse200DataItemsItemQrSettingsType0DotStyle(_dot_style)
        ...
        if isinstance(_marker_border_style, Unset):
            ...
            marker_border_style = GetLinksResponse200DataItemsItemQrSettingsType0MarkerBorderStyle(
        ...
        if isinstance(_marker_center_style, Unset):
            ...
            marker_center_style = GetLinksResponse200DataItemsItemQrSettingsType0MarkerCenterStyle(
                _marker_center_style
            )

        get_links_response_200_data_items_item_qr_settings_type_0 = cls(
        ...
        return get_links_response_200_data_items_item_qr_settings_type_0
